...
- Compare Bayesian-GP mapping with Kalman Filter implementation.
...
- Kalman Filter (KF) implementation for comparison
...
- ~8.1% lower estimation error (MSE) vs. the KF baseline
